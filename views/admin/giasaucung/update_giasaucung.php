      ...
      <div>
        ...
        <select name="doituong_id" id="doituong_id">
          ...
          foreach($arr_doituong as $b){
            if($b->id == $arr_find->doituong_id){
            ?>
          <option value="<?=$b->id?>" selected><?=$b->loai_doituong?></option>
          <?php
          }else{
            ?>
      ...
      <div>
        ...
        <select name="thoidiem_id" id="thoidiem_id">
          ...
          foreach($arr_thoidiem as $c){
            if($c->id == $arr_find->thoidiem_id){
            ?>
          <option value="<?=$c->id?>" selected><?=$c->loai_thoidiem?></option>
          <?php
          }else{
            ?>
      ...
      <div>
        ...
        <select name="dvkemtheo_id" id="dvkemtheo_id">
          ...
          foreach($arr_dichvu as $d){
            if($d->id == $arr_find->dvkemtheo_id){
            ?>
          <option value="<?=$d->id?>" selected><?=$d->loai_dichvu?></option>
          <?php
          }else{
            ?>
